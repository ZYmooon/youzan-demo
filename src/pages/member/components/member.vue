    ...
    <div class="content">
      <div class="user-infos">
        <div class="pull-left avatar">
          <div class="img" style="background-image: url(http://p61rbcy24.bkt.clouddn.com/avatar.png);"></div>
        </div>
      ...
      <div class="order-related">
        ...
        <div class="block block-list list-vertical">
          <router-link class="block-item link clearfix ico-setting js-login" href="https://h5.youzan.com/v2/buyer/member/setting" to="/address">
